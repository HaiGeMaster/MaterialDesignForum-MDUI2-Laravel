<template>
  ...
  >
    ...
    <Header
      :text="$t('Message.Client.Index.HeaderTitle')"
      :to="
    ...
    <div class="items-wrapper">
      <Items
        :title="$t('Message.Client.Index.LatestQuestions')"
        :type="'questions'"
        :order="'-update_time'"
        :title_url="`${$G_UrlHeaderLang()}/questions`"
      />
      <Items
        :title="$t('Message.Client.Index.RecentlyPopularQuestions')"
        :type="'questions'"
        :order="'-vote_count'"
    ...
    <div class="items-wrapper">
      <Items
        :title="$t('Message.Client.Index.LatestArticles')"
        :type="'articles'"
        :order="'-update_time'"
        :title_url="`${$G_UrlHeaderLang()}/articles`"
      />
      <Items
        :title="$t('Message.Client.Index.RecentlyPopularArticles')"
        :type="'articles'"
        :order="'-vote_count'"
    ...
    <div class="items-wrapper">
      <Items
        :title="$t('Message.Client.Index.NewlyJoinedPeople')"
        :type="'users'"
        :users_type="'recommended'"
        :order="'-create_time'"
        title_icon="mdi-new-box"
        title_icon_color="orange"
      />
      <Items
        :title="$t('Message.Client.Index.TheMostPopularPerson')"
        :type="'users'"
        :users_type="'recommended'"
        :order="'-follower_count'"
        title_icon="mdi-fire"
        title_icon_color="red"
      />
    </div>
