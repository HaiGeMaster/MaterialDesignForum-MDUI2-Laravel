<template>
  <mdui-dropdown>
    ...
    <mdui-menu>
      <mdui-menu-item @click.prevent.stop="SpawnCopyLink()" v-if="LookCopyShowRule">
      ...
      <mdui-menu-item @click.prevent.stop="EditItem()" v-if="LookEditShowRule">
        <mdi-icon slot="icon" icon="mdi-pencil" />
        {{ EditText }}
      </mdui-menu-item>
      <mdui-menu-item @click.prevent.stop="DeleteItem()" v-if="LookDeleteShowRule">
        <mdi-icon slot="icon" icon="mdi-delete" />
        {{ DeleteText }}
      </mdui-menu-item>
      <mdui-menu-item @click.prevent.stop="ResetCover()" v-if="LookResetCoverShowRule">
        <mdi-icon slot="icon" icon="mdi-image-edit-outline" />
        {{ $t('Message.Components.OptionsButton.ResetCover') }}
      </mdui-menu-item>
      <mdui-menu-item @click.prevent.stop="ResetAvatar()" v-if="LookResetAvatarShowRule">
        <mdi-icon slot="icon" icon="mdi-account-edit-outline" />
        {{ $t('Message.Components.OptionsButton.ResetAvatar') }}
      </mdui-menu-item>
    </mdui-menu>
  </mdui-dropdown>
</template>
