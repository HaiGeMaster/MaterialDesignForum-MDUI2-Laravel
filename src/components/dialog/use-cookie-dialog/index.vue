<template>
  ...
  <!-- headline="管理 Cookie" :stacked-actions="$store.getters.GetMobile" -->
...
<!-- :full-width="$store.getters.GetMobile" -->
    <mdui-button slot="action" @click="acceptOptional" full-width
      style="width:100%;">
    ...
    <mdui-button slot="action" variant="tonal" @click="rejectOptional" full-width
      style="width:100%;">
    ...
    <mdui-button slot="action" variant="outlined" @click="manageCookies" full-width
      style="width:100%;">
      {{ $t('Message.Components.UseCookieDialog.cookieConsent.manage') }}
    </mdui-button>

    <!-- <div style="margin: 16px;" slot="action" v-show="!$store.getters.GetMobile"></div> -->

    <!-- <div class="flex-grow" slot="action"></div> -->

    <div slot="action" style="width:100%;">
      <LanguageButton cookie_dialog></LanguageButton>
    </div>

    <mdui-dialog :headline="$t('Message.Components.UseCookieDialog.cookieConsent.dialogTitle')" ref="dialog" :stacked-actions="$store.getters.GetMobile"
      ...
      <div slot="description">
        ...
        <p>
              <!-- 示例 Cookie: -->
              {{ $t('Message.Components.UseCookieDialog.cookieConsent.exampleCookies') }}</p>
        <table>
          <thead>
             <tr>
                  <th>{{ $t('Message.Components.UseCookieDialog.cookieFields.field_name') }}</th>
      ...
      <mdui-button slot="action" @click="savePreferences" :full-width="$store.getters.GetMobile"
        :style="$store.getters.GetMobile ? 'width:100%' : ''">
        <!-- 保存 -->
        {{ $t('Message.Components.UseCookieDialog.cookieConsent.save') }}
      </mdui-button>
      <mdui-button slot="action" variant="tonal" @click="closeDialog" :full-width="$store.getters.GetMobile"
        :style="$store.getters.GetMobile ? 'width:100%' : ''">
        <!-- 关闭 -->
